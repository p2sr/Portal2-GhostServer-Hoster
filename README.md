...
- [Node.js](https://nodejs.org/), [Docker](https://www.docker.com/), and [Flutter](https://flutter.dev) installed on your machine
...
Ghost Servers are managed using Docker, which allows us to dynamically create and destroy instances of the server program. To interact with the server written in C++, we use a [Node.js C++ Addon](https://nodejs.org/api/addons.html), which allows a Node.js package to talk to C++ in a nice way.
